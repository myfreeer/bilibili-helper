...
var utils={bindFn:function(b,c){var a=Array.prototype.slice.call(arguments,2);return function(){return b.apply(c,a.concat(Array.prototype.slice.call(arguments)))}},cookie:{get:function(b){var c=""+document.cookie,a=c.indexOf(b+"=");if(-1==a||""==b)return"";var d=c.indexOf(";",a);-1==d&&(d=c.length);return unescape(c.substring(a+b.length+1,d))},set:function(b,c,a){a=void 0!==a?a:365;var d=new Date;d.setTime(d.getTime()+864E5*a);document.cookie=b+"="+escape(c)+";expires="+d.toGMTString()+"; path=/; domain=.bilibili.com"},
"delete":function(b){this.set(b,"",-1)}}};window.__GetCookie=utils.bindFn(utils.cookie.get,utils);window.__SetCookie=utils.bindFn(utils.cookie.set,utils);